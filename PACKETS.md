...
TODO: Match response handlers to packet address and write description.

| Packet ID | Packet Type | Address | Callback | Description |
| --------- | ----------- | ------- | -------- | ----------- |
| 0x4 | 1 | 0x232c6a8 | `MediusUniqueCallbackSessionBeginResponseHandler` | Handles session begin.
| 0x8 | 1 | 0x232c758 | `MediusUniqueCallbackSessionEndResponseHandler` | Handles session end.
| 0x6 | 1 | 0x232c708 | `MediusUniqueCallbackAccountLoginResponseHandler` | Handles login response.
| 0x10 | 1 | 0x232c7e8  | `MediusUniqueCallbackAccountRegistrationResponseHandler` | Handles account registration.
| 0xc | 1 | 0x232c820 | `MediusUniqueCallbackAccountGetProfileResponseHandler` | Handles profile `GET` response.
| 0xe | 1 | 0x232c858 | `MediusUniqueCallbackAccountUpdateProfileResponseHandler` | Handles profile `UPDATE` response.
| 0x10 | 1 | 0x232c890 | `MediusUniqueCallbackAccountUpdatePasswordResponseHandler` | Handles password `UPDATE` response.
| 0x12 | 1 | 0x232c8c8 | `MediusUniqueCallbackAccountUpdateStatsResponseHandler` | Handles statistics updating.
| 0x14 | 1 | 0x232d678 | `MediusUniqueCallbackAnonymousLoginResponseHandler` | Handles anonymous logins.
| 0x16 | 1 | 0x232c7b0 | `MediusUniqueCallbackCreateGameResponseHandler` | Handles creating servers.
| 0x18 | 1 | 0x232d6b0 | `MediusUniqueCallbackCreateChannelResponseHandler` |
| 0x1a | 1 | 0x232c900 | `MediusUniqueCallbackJoinGameResponseHandler` |
| 0x1e | 1 | 0x232c938 | `MediusUniqueCallbackJoinChannelResponseHandler` |
| 0x1c | 1 | 0x232d598 | `MediusUniqueCallbackJoinChannelFwdResponseHandler` |
| 0x1e | 1 | 0x232c938 | `MediusUniqueCallbackGameListResponseHandler` |
| 0x22 | 1 | 0x232c970 | `` |
| 0x24 | 1 | 0x232c9a8 | `` |
| 0x26 | 1 | 0x232c9e0 | `` |
| 0x28 | 1 | 0x232ca18 | `` |
