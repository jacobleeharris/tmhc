...
INCLUDE_ASM("asm/nonmatchings/tmhc/Slink", Platform_RunFromDest__5Slinki);

INCLUDE_ASM("asm/nonmatchings/tmhc/Slink", Platform_GetDefaultLoadAddr__5Slink);

INCLUDE_ASM("asm/nonmatchings/tmhc/Slink", Platform_ManualFlowControl__5Slinkb);
