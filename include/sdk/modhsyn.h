...
#define sceHSyn_GetVoiceCtrlPort(x)                                            \
  ((((int)(x)) & 0x80) ? (((int)(x)) & 0xf) : -1)
...
extern int sceHSyn_SERetrieveVoiceNumberByID(sceCslCtx *, unsigned int,
                                             unsigned int, char *, char);
extern int sceHSyn_SERetrieveAllSEMsgIDs(sceCslCtx *, unsigned int,
                                         unsigned int *, int);
extern int sceHSyn_MSGetVoiceStateByID(sceCslCtx *, unsigned int, unsigned char,
                                       unsigned char *, char);
extern int sceHSyn_MSGetVoiceEnvelopeByID(sceCslCtx *, unsigned int,
