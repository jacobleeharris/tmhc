...
extern enum SceILsockErrorCode
sceILsockBind(int sock, struct sceILsock_addr *name, int namelen);

extern enum SceILsockErrorCode
sceILsockConnect(int sock, struct sceILsock_addr *name, int namelen);
