...
#define sceSEIn_MakeMsgData(d0, d1, d2, d3)                                    \
  ((((unsigned int)(d0)) & 0xff) | ((((unsigned int)(d1)) & 0xff) << 8) |      \
...
#define sceSEIn_NoteOff(ctx, port, id, bank, prog, note)                       \
  sceSEIn_PutMsg(                                                              \
      (ctx), (port), (id),                                                     \
      sceSEIn_MakeMsg4((unsigned int)(bank) | 0xa0, (prog), (note), 0), 0)
...
extern int sceSEIn_PutMsg(sceCslCtx *, unsigned int, unsigned int, unsigned int,
                          unsigned int);
extern int sceSEIn_PutSEMsg(sceCslCtx *, unsigned int, unsigned int,
                            unsigned char *, unsigned int);
extern int sceSEIn_MakeNoteOn(sceCslCtx *, unsigned int, unsigned int,
                              unsigned int, unsigned int, unsigned int,
                              unsigned int, int);
extern int sceSEIn_MakePitchOn(sceCslCtx *, unsigned int, unsigned int,
                               unsigned int, unsigned int, unsigned int,
                               unsigned int, int, unsigned int);
extern int sceSEIn_MakeTimeLfoCycle(sceCslCtx *, unsigned int, unsigned int,
                                    unsigned int, unsigned int, unsigned int,
                                    unsigned int, unsigned int, unsigned int);
extern int sceSEIn_MakeTimeVolume(sceCslCtx *, unsigned int, unsigned int,
                                  unsigned int, unsigned int, unsigned int,
                                  unsigned int, unsigned int);
extern int sceSEIn_MakeTimePanpot(sceCslCtx *, unsigned int, unsigned int,
                                  unsigned int, unsigned int, unsigned int,
                                  unsigned int, int, unsigned int);
extern int sceSEIn_MakeTimePitch(sceCslCtx *, unsigned int, unsigned int,
                                 unsigned int, unsigned int, unsigned int,
                                 unsigned int, unsigned int, unsigned int);
extern int sceSEIn_MakePitchLFO(sceCslCtx *, unsigned int, unsigned int,
                                unsigned int, unsigned int, unsigned int,
                                unsigned int, unsigned int);
extern int sceSEIn_MakeAmpLFO(sceCslCtx *, unsigned int, unsigned int,
                              unsigned int, unsigned int, unsigned int,
                              unsigned int, unsigned int);
extern int sceSEIn_MakeAllNoteOff(sceCslCtx *, unsigned int, unsigned int);
extern int sceSEIn_MakeAllNoteOffMask(sceCslCtx *, unsigned int, unsigned int,
                                      unsigned int, unsigned int);
extern int sceSEIn_MakeNoteOnZero(sceCslCtx *, unsigned int, unsigned int,
                                  unsigned int, unsigned int, unsigned int,
                                  unsigned int, int);
extern int sceSEIn_MakePitchOnZero(sceCslCtx *, unsigned int, unsigned int,
                                   unsigned int, unsigned int, unsigned int,
                                   unsigned int, int, unsigned int);
#ifdef __cplusplus
}
