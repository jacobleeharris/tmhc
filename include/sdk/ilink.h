...
extern int sce1394TrDataInd(int offH, u_int offL, u_int size,
...
#define sce1394PbSetSize(pb, size) sce1394PbSet(pb, SCE1394PB_SIZE, size)
#define sce1394PbSetSpeed(pb, speed) sce1394PbSet(pb, SCE1394PB_SPEED, speed)

#define sce1394PbSetTCode(pb, tCode) sce1394PbSet(pb, SCE1394PB_TCODE, tCode)
#define sce1394PbSetTLabel(pb, tLabel)                                         \
  sce1394PbSet(pb, SCE1394PB_TLABEL, tLabel)
#define sce1394PbSetDest(pb, dest) sce1394PbSet(pb, SCE1394PB_DEST, dest)
#define sce1394PbSetSource(pb, source)                                         \
  sce1394PbSet(pb, SCE1394PB_SOURCE, source)
#define sce1394PbSetOffsetH(pb, offH) sce1394PbSet(pb, SCE1394PB_OFFH, offH)
#define sce1394PbSetOffsetL(pb, offL) sce1394PbSet(pb, SCE1394PB_OFFL, offL)
...
#define sce1394PbSetRCode(pb, rCode) sce1394PbSet(pb, SCE1394PB_RCODE, rCode)
...
#define sce1394TrSetSpeed(tc, speed) sce1394TrSet(tc, SCE1394TR_SPEED, speed)
#define sce1394TrSetBlockSize(tc, size) sce1394TrSet(tc, SCE1394TR_BSIZE, size)
...
extern int sce1394TrLock(int tc, int offH, u_int offL, int len, void *buff,
                         int ex_tCode);
...
extern int sce1394TrWriteV(int tc, int offH, u_int offL, int cnt,
                           sce1394Iov *iov);
extern int sce1394TrReadV(int tc, int offH, u_int offL, int cnt,
                          sce1394Iov *iov);
...
#define sce1394HtoN32(host32)                                                  \
  ((((host32) >> 8) & 0xff00) | (((host32)&0xff00) << 8) | ((host32) << 24) |  \
   ((unsigned)(host32) >> 24))
#endif /* __MIPSEL__ */
#ifdef __MIPSEB__
