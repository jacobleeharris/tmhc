...
#define SCE_ELINKERROR                                                         \
  0x902b /* ロードしたモジュールが必要とする常駐ライブラリが存在しない */
...
#define SCE_EALREADY_STARTED                                                   \
  0x902f                        /* 指定したモジュールは既にスタートしている */
#define SCE_ENOT_STARTED 0x9030 /* 指定したモジュールはスタートしていない */
#define SCE_EALREADY_STOPPING 0x9031 /* 指定したモジュールはストップ処理中 */
#define SCE_EALREADY_STOPED                                                    \
  0x9032                          /* 指定したモジュールは既にストップしている */
...
#define SCE_ERROR_PREFIX_USBPSPCM                                              \
  0x010a0000 /* PS2/PSP comm.         usbpspcm */
...
/* for library author */
#define SCE_ERROR_ENCODE(prefix, err)                                          \
  (SCE_ERROR_PREFIX_ERROR | (prefix) | (err))
