...
enum { sceNetcnfifArg_f_no_decode_off, sceNetcnfifArg_f_no_decode_on };
...
enum { sceNetcnfifData_mtu_no_set = -1, sceNetcnfifData_mtu_default = 1454 };

enum { sceNetcnfifData_idle_timeout_no_set = -1 };
...
enum { sceNetcnfifData_f_auth_off, sceNetcnfifData_f_auth_on };

enum { sceNetcnfifData_auth_chap_pap = 4 };

enum { sceNetcnfifData_pppoe_no_set = 0xff, sceNetcnfifData_pppoe_use = 1 };
...
/*** callback ***/
typedef int (*sceNetcnfifOpenFunction)(const char *device, const char *pathname,
                                       int flags, int mode, int *filesize);
typedef int (*sceNetcnfifReadFunction)(int fd, const char *device,
                                       const char *pathname, void *buf,
                                       int offset, int size);
...
int sceNetcnfifCreateCallbackThread(sceNetcnfifCallback_t *pcallback,
                                    char *stack, int size, int priority);
...
int sceNetcnfifGetList(const char *fname, int type, sceNetcnfifList_t *addr,
                       int size);
int sceNetcnfifLoadEntry(const char *fname, int type, const char *usr_name,
                         sceNetcnfifData_t *addr);
int sceNetcnfifLoadEntryAuto(const char *fname, int type_with_flags,
                             const char *usr_name, sceNetcnfifData_t *addr);
int sceNetcnfifAddEntry(const char *fname, int type, const char *usr_name);
int sceNetcnfifEditEntry(const char *fname, int type, const char *usr_name,
                         const char *new_usr_name);
int sceNetcnfifDeleteEntry(const char *fname, int type, const char *usr_name);
int sceNetcnfifSetLatestEntry(const char *fname, int type,
                              const char *usr_name);
...
int sceNetcnfifCheckSpecialProvider(const char *fname, int type,
                                    const char *usr_name);
