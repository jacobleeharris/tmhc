...
#define SCE_MC2_FUNC_READFILE_FAST (32)
#define SCE_MC2_FUNC_WRITEFILE_FAST (33)
...
#define sceMc2FuncReadFastFile		SCE_MC2_FUNC_READFILE_FAST
#define sceMc2FuncWriteFastFile		SCE_MC2_FUNC_WRITEFILE_FAST
...
int sceMc2ReadFastFileAsync(int id, const char* name, void* bufs, int ofs, unsigned int size);
int sceMc2WriteFastFileAsync(int id, const char* name, const void* bufs, int ofs, unsigned int size);

int sceMc2ReadFastFile(int id, const char* name, void* bufs, int ofs, unsigned int size);
int sceMc2WriteFastFile(int id, const char* name, const void* bufs, int ofs, unsigned int size);
